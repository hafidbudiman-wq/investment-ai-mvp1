...
export const P0A_ROUTER_VERSION = "p0a-page-router-v2-note-masthead";
...
export const P0A_VERSION_SET = Object.freeze({
  ...
  parser: P0A_PARSER_VERSION,
  router: P0A_ROUTER_VERSION,
  applicability: P0A_APPLICABILITY_VERSION,
