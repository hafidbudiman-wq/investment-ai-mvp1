...
export const P0A_REQUIREMENTS = [
  ...
  p("OPERATING_PROFIT", "Issuer-defined operating profit; never automatically relabeled EBIT.", "INCOME_STATEMENT", "EXPECTED", "DOCUMENT_CURRENCY", "DURATION", ["PRIMARY", "NOTE"], ["operating profit", "profit from operations", "laba usaha", "laba operasi", "laba operasional"]),
  ...
  p("WEIGHTED_AVG_SHARES", "Duration denominator used for EPS; not period-end shares.", "INCOME_STATEMENT", "EXPECTED", "SHARES", "DURATION", ["NOTE", "PRIMARY"], ["weighted average number of shares", "weighted average number of ordinary outstanding share", "jumlah rata-rata tertimbang saham", "rata rata tertimbang saham biasa yang beredar"]),
  ...
  p("TREASURY_SHARES", "Treasury-share count; zero requires evidence.", "BALANCE_SHEET", "OPTIONAL", "SHARES", "INSTANT", ["PRIMARY", "NOTE", "OFFICIAL_EXTERNAL"], ["capital stock", "modal saham", "treasury shares", "saham treasuri"]),
